...
| 2026-09-02 | HF snapshots | Skip ONNX; keep `pytorch_model.bin` if safetensors is missing | ONNX still skipped; ignoring the bin left a weight-less cache on Railway | — |
